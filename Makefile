...
PROMPT_SRC = \
    ...
    $(addprefix parser/, parseur.c utils.c utils_lst.c fill.c split2.c get_var.c wildcard.c get_wildcard.c utils_wildcard.c cut_line.c utils2.c) \
	$(addprefix ast/, get_ast.c bt_utils.c clear_utils.c)
